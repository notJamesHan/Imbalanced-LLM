...
DATASETS_OFFLINE = "/content/drive/MyDrive/Colab/TabLLM/datasets_serialized"
...
class CustomCategoricalReader(BaseDatasetReader):
    ...
    def get_template(self, template_idx):
        ...
        yaml_dict = yaml.load(open('/content/drive/MyDrive/Colab/TabLLM/templates/templates_' + task + '.yaml', "r"),
