...
def main():
    ...
    for args.dataset in args_datasets:
        ...
        num_shots = [4]  #  8, 16, 32, 64, 128, 256, 512, 'all', 1024, 2048, 4096, 8192, 16384, 50000, 'all']  # ['all'] # Change here
        seeds = [42, 1024, 0, 1, 32]   # , 45, 655, 186, 126, 836] # change Here
